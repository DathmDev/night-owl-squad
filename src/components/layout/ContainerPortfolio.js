                            ...
                            <div className="row">
                                <div className="hidden-lg hidden-md col-sm-12 col-xs-12">
                                    <div className="block1">
                                        <div className = "myinfo">
                                            ...
                                            <p>
                                            Email: haminhdat01@gmail.com
                                            </p>
                                        </div>
                                        <div className="category form-horizontal">
                                            <div><h1>SKILLS</h1></div>
                                            <div className="form-group">
                                                <label className="item col-sm-2 col-xs-2">Communication </label>
                                                <div className="stars">
                                                    <form action="">
                                                        <input className="star star-5" id="star-5" type="radio" name="star" checked />
                                            ...
                                            <div className="form-group">
                                                <label className="item col-sm-2 col-xs-12">Work group </label>
                                                <div className="stars">
                                                    <form action="">
                                                        <input className="star star-10" id="star-10" type="radio" name="star"/>
                                                        <label className="star star-10" for="star-10"></label>
                                                        <input className="star star-9" id="star-9" type="radio" name="star" checked />
                                                        <label className="star star-9" for="star-9"></label>
                                                        <input className="star star-8" id="star-8" type="radio" name="star"/>
                                                        <label className="star star-8" for="star-8"></label>
                                                        <input className="star star-7" id="star-7" type="radio" name="star"/>
                                                        <label className="star star-7" for="star-7"></label>
                                                        <input className="star star-6" id="star-6" type="radio" name="star"/>
                                                        <label className="star star-6" for="star-6"></label>
                                                    </form>
                                                </div>
                                            </div>
                                            <div className="form-group">
                                                <label className="item col-sm-2 col-xs-12">Photoshop</label>
                                                <div className="stars">
                                                    <form action="">
                                                        <input className="star star-15" id="star-15" type="radio" name="star"/>
                                                        <label className="star star-15" for="star-15"></label>
                                                        <input className="star star-14" id="star-14" type="radio" name="star"/>
                                                        <label className="star star-14" for="star-14"></label>
                                                        <input className="star star-13" id="star-13" type="radio" name="star"/>
                                                        <label className="star star-13" for="star-13"></label>
                                                        <input className="star star-12" id="star-12" type="radio" name="star" checked />
                                                        <label className="star star-12" for="star-12"></label>
                                                        <input className="star star-11" id="star-11" type="radio" name="star"/>
                                                        <label className="star star-11" for="star-11"></label>
                                                    </form>
                                                </div>
                                            </div>
                                            <div className="form-group">
                                                <label className="item col-sm-2 col-xs-12">C/C++</label>
                                                <div className="stars">
                                                    <form action="">
                                                        <input className="star star-20" id="star-20" type="radio" name="star"/>
                                                        <label className="star star-20" for="star-20"></label>
                                                        <input className="star star-19" id="star-19" type="radio" name="star" checked />
                                                        <label className="star star-19" for="star-19"></label>
                                                        <input className="star star-18" id="star-18" type="radio" name="star"/>
                                                        <label className="star star-18" for="star-18"></label>
                                                        <input className="star star-17" id="star-17" type="radio" name="star"/>
                                                        <label className="star star-17" for="star-17"></label>
                                                        <input className="star star-16" id="star-16" type="radio" name="star"/>
                                                        <label className="star star-16" for="star-16"></label>
                                                    </form>
                                                </div>
                                            </div>
                                            <div className="form-group">
                                                <label className="item col-sm-2 col-xs-12">C#</label>
                                                <div className="stars">
                                                    <form action="">
                                                        <input className="star star-25" id="star-25" type="radio" name="star"/>
                                                        <label className="star star-25" for="star-25"></label>
                                                        <input className="star star-24" id="star-24" type="radio" name="star"/>
                                                        <label className="star star-24" for="star-24"></label>
                                                        <input className="star star-23" id="star-23" type="radio" name="star" checked />
                                                        <label className="star star-23" for="star-23"></label>
                                                        <input className="star star-22" id="star-22" type="radio" name="star"/>
                                                        <label className="star star-22" for="star-22"></label>
                                                        <input className="star star-21" id="star-21" type="radio" name="star"/>
                                                        <label className="star star-21" for="star-21"></label>
                                                    </form>
                                                </div>
                                            </div>
                                            <div className="form-group">
                                                <label className="item col-sm-2 col-xs-12">HTML/CSS</label>
                                                <div className="stars">
                                                    <form action="">
                                                        <input className="star star-30" id="star-30" type="radio" name="star"/>
                                                        <label className="star star-30" for="star-30"></label>
                                                        <input className="star star-29" id="star-29" type="radio" name="star"/>
                                                        <label className="star star-29" for="star-29"></label>
                                                        <input className="star star-28" id="star-28" type="radio" name="star"/>
                                                        <label className="star star-28" for="star-28"></label>
                                                        <input className="star star-27" id="star-27" type="radio" name="star" checked />
                                                        <label className="star star-27" for="star-27"></label>
                                                        <input className="star star-26" id="star-26" type="radio" name="star"/>
                                                        <label className="star star-26" for="star-26"></label>
                                                    </form>
                                                </div>
                                            </div>
                                            <div className="form-group">
                                                <label className="item col-sm-2 col-xs-12">Android</label>
                                                <div className="stars">
                                                    <form action="">
                                                        <input className="star star-35" id="star-35" type="radio" name="star"/>
                                                        <label className="star star-35" for="star-35"></label>
                                                        <input className="star star-34" id="star-34" type="radio" name="star" checked />
                                                        <label className="star star-34" for="star-34"></label>
                                                        <input className="star star-33" id="star-33" type="radio" name="star"/>
                                                        <label className="star star-33" for="star-33"></label>
                                                        <input className="star star-32" id="star-32" type="radio" name="star"/>
                                                        <label className="star star-32" for="star-32"></label>
                                                        <input className="star star-31" id="star-31" type="radio" name="star"/>
                                                        <label className="star star-31" for="star-31"></label>
                                                    </form>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <div className="hidden-xs hidden-sm col-lg-4 col-md-4">
                                    <div className="block1">
                                        ...
                                        <div className="category">
                                            <div><h1>SKILLS</h1></div>
                                            <label className="item">Communication </label>
                                            <div className="stars">
                                            <form action="">
                                                <input className="star star-5" id="star-5" type="radio" name="star" checked />
                                                <label className="star star-5" for="star-5"></label>
                                            ...
                                            <label className="item">Work group </label>
                                            <div className="stars">
                                            <form action="">
                                                <input className="star star-10" id="star-10" type="radio" name="star"/>
                                                <label className="star star-10" for="star-10"></label>
                                            ...
                                            <label className="item">Photoshop</label>
                                            <div className="stars">
                                            <form action="">
                                                <input className="star star-15" id="star-15" type="radio" name="star"/>
                                                <label className="star star-15" for="star-15"></label>
                                            ...
                                            <label className="item">C/C++</label>
                                            <div className="stars">
                                            <form action="">
                                                <input className="star star-20" id="star-20" type="radio" name="star"/>
                                                <label className="star star-20" for="star-20"></label>
                                            ...
                                            <label className="item">HTML/CSS</label>
                                            <div className="stars">
                                            <form action="">
                                                <input className="star star-30" id="star-30" type="radio" name="star"/>
                                                <label className="star star-30" for="star-30"></label>
                                            ...
                                            <label className="item">Android</label>
                                            <div className="stars">
                                            <form action="">
                                                <input className="star star-35" id="star-35" type="radio" name="star"/>
                                                <label className="star star-35" for="star-35"></label>
